    ...
    <div className="flex flex-col md:flex-row justify-center items-center mt-5">
      <div className="w-full">
        <span className="text-white text-2xl underline font-bold">
          <i className="fa-solid fa-bullseye fa-xs mr-2" />
          2024 Goals
        </span>
        <div className="mt-2">
          <li className="ml-4 text-white">
            <i className="fa-brands fa-golang mr-2" />
            Mastery Of Golang
            <br />
          ...
          <li className="ml-4 text-white mt-1">
            <i className="fa-brands fa-python mr-2" />
          ...
          <li className="ml-4 text-white mt-1">
            <i className="fa-brands fa-react mr-2" />
